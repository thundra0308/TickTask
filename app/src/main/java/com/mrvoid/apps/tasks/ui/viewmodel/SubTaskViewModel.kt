...
import com.mrvoid.apps.tasks.util.AppConstants.SEARCH_INITIAL_VALUE
import com.mrvoid.apps.tasks.util.AppConstants.SEARCH_QUERY
import com.mrvoid.apps.tasks.util.AppConstants.SHARE_FORMAT
import com.mrvoid.apps.tasks.util.AppConstants.TASK_ID
