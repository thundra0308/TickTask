...
object AppConstants {
    ...
    //notification
    const val NOTIFICATION_CHANNEL_ID = "com.mrvoid.apps.mytask.notificationID"
    const val NOTIFICATION_CHANNEL_NAME = "Reminder"
    const val NOTIFICATION_CHANNEL_DESCRIPTION = "Task reminder"
    const val NOTIFICATION_DAILY_CHANNEL_ID = "com.mrvoid.apps.mytask.notification_daily_id"
    ...
    const val DEEP_LINK_SUBTASK  = "tasks://com.mrvoid.apps.tasks/subtaskscreen/"
    // Preferences key
